...
Le menu final est un résumé de votre machine, vérifiez donc que vous avez tous bien sélectionné avant de terminer la création de votre serveur.
...
Pour le menu final, ne cochez rien, à moins qu’il y ait un sevrer snap que vous voudriez utiliser et attendez l’installation.

Après l’installation s’est terminée, déconnectez le lecteur CD/DVD et redémarrez le serveur. Si tout s’est bien passé, vous pouvez vous connecter et commencer à utiliser votre serveur.
